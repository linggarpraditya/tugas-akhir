<div class="main-content">
	...
	<section class="section">
		...
		<a href="<?php echo base_url('admin/data_mobil/tambah_mobil') ?>" class="btn btn-primary mb-3 "><i class="fas fa-user-plus"></i>Tambah Data</a>
				...
				foreach ($mobil as $mb) : ?>
					<tr>
						...
						<td>
							...
							<a onclick="return confirm('apakah anda yakin untuk menghapus ?')" href="<?php echo base_url('admin/data_mobil/delete_mobil/') . $mb->id_mobil ?>" class="btn btn-sm btn-danger">
