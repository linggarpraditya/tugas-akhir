							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select name="kode_type" class="form-control">
										<option value="<?php echo $mb->kode_type ?>"></option>
          					...
          					text-danger">', '</div>') ?>
								...
								<div class="form-group">
									...
									<select name="status" class="form-control">
										<option <?php if ($mb->status == "Tersedia") {
													echo "selected='selected'";
												}
												echo $mb->status; ?>values="1">Tersedia</option>
										<option <?php if ($mb->status == "Tidak Tersedia") {
													echo "selected='selected'";
												}
												echo $mb->status; ?>values="0">Tidak Tersedia</option>
									</select>
          					...
          					text-danger">', '</div>') ?>
								...
								<!-- <div class="form-group">
                                   ...
                                   <select name="ac" class="form-control">
										...
										echo $mb->ac; ?>values="1">Tersedia</option>
                                        <option <?php if ($mb->ac == "0") {
											echo "selected'selected'";
										}
										echo $mb->ac; ?>values="0">Tidak Tersedia</option>
                                   </select>
                              ...
                              <div class="form-group">
                                   ...
                                   <select name="supir" class="form-control">
										...
										echo $mb->supir; ?>values="1">Tersedia</option>
                                        <option <?php if ($mb->supir == "0") {
											echo "selected'selected'";
										}
										echo $mb->supir; ?>values="0">Tidak Tersedia</option>
                                   </select>
                              ...
                              <div class="form-group">
                                   ...
                                   <select name="mp3_player" class="form-control">
										...
										echo $mb->mp3_player; ?>values="1">Tersedia</option>
                                        <option <?php if ($mb->mp3_player == "0") {
											echo "selected'selected'";
										}
										echo $mb->mp3_player; ?>values="0">Tidak Tersedia</option>
                                   </select>
